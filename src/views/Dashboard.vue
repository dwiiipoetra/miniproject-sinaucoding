                                    ...
                                    <td>
                                        <label class="users-table__checkbox">
                                            ...
                                            <div class="categories-table-img">
                                                <picture>
                                                    <source srcset="../assets/img/categories/01.webp" type="image/webp">
                                                    <img src="../assets/img/categories/01.jpg" alt="category">
                                                </picture>
                                            </div>
                                        </label>
                                    </td>
                                        ...
                                        <div class="pages-table-img">
                                            <picture>
                                                <source srcset="../assets/img/avatar/avatar-face-04.webp"
                                                    type="image/webp"><img src="../assets/img/avatar/avatar-face-04.png"
                                                    alt="User Name">
                                            </picture>
                                            Jenny Wilson
                                        </div>
